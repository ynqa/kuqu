# Contributing to kuqu

We welcome contributions to "kuqu" and greatly appreciate your help in making
...
[kuqu repository](https://github.com/ynqa/kuqu) to create a copy of the
...
```bash
git clone https://github.com/<your_username>/kuqu.git
```
...
[kuqu Pull Request page](https://github.com/ynqa/kuqu/pulls) and click the
...
Thank you for considering contributing to "kuqu"!
